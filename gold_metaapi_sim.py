...
SYMBOL      = "Gold"    # Nom exact RaiseFX MT5 (G majuscule)
...
ATR_SPIKE_MULT  = 2.5
SL_ATR_MULT     = 1.5
PIP_GOLD        = 0.01   # 1 pip = 0.01 sur Gold CFD RaiseFX (chiffres=2)
SL_MIN_PIPS     = 150    # 150 pips min = 1.50$ (equivalent 15 pips spot XAUUSD)
SL_MAX_PIPS     = 1500   # 1500 pips max = 15$ (equivalent 150 pips spot)
RETEST_THRESH   = 10.0   # 10 points max de retest EMA20 M5 (Gold CFD ~4544)
TP_RR_MARKET    = 1.5
TP_RR_SNIPER    = 3.0
VOL_THRESHOLD   = 0.70
STOCH_OB        = 80
...
async def analyse_gold(api, account):
    ...
    try:
        ...
        try:
            ...
            print("DXY scoring erreur : " + str(e), flush=True)
            score_log.append("DXY:N/A")
